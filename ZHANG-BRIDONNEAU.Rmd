...
où $H_n(\lambda) = \dfrac{\partial^2 L_{max}}{\partial^2 \lambda} = \left|\dfrac{\partial h_{\lambda}(Y)}{\partial \lambda} \right|^{'} \left|\dfrac{\partial h_{\lambda}(Y)}{\partial \lambda} \right| + \left|\dfrac{\partial^2 h_{\lambda}(Y)}{\partial^2 \lambda} \right| (I_n-H)h_{\lambda}(Y)$.
